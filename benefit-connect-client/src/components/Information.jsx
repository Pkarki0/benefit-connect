  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 pt-16 pb-16 bg-[#FFFCF2]">
      ...
      <div className="flex gap-8">
        <InformationCard heading="Important information for people who don’t have legal status in USA or who are temporary residents">
          <div className="bg-yellow-50 border-2 border-yellow-500 text-black p-4 rounded-lg shadow-md">
            <p className="mb-4">
              <strong>Important</strong>
            </p>
            <p className="text-lg">
              If you do not have legal status in USA, or if you are a temporary
              ...
              America’s Legal Aid Program website. On it, there are links for
        ...
        <InformationCard heading="Important information about benefits for Indigenous peoples (First Nations, Inuit, Métis, or other)">
          <div className="bg-yellow-50 border-2 border-yellow-500 text-black p-4 rounded-lg shadow-md">
            ...
            <p>
              ...
              provincial, territorial, and federal governments. Before applying
              to any benefits, you should speak with your governing body, if
              applicable.
            </p>
            <ul className="list-disc list-inside mb-4">
              <li>
                If you are First Nations: speak with your administration, band,
                or governing body.
              </li>
              <li>
            ...
            <p>
              AFOA USA and Prosper USA are currently seeking funding to develop
              an online tool that serves the needs of Indigenous people living
              in USA.
            </p>
          </div>
        </InformationCard>
